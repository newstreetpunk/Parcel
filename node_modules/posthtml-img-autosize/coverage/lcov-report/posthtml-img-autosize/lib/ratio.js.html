...
<head>
    <title>Code coverage report for posthtml-img-autosize/lib/ratio.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">posthtml-img-autosize/lib</a> ratio.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">10x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">module.exports = function (target, source) {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (isPixel(target[adjacentSide])) {
            output[side] = Math.round(source[side] * (target[adjacentSide] / source[adjacentSide]));
            return;
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Unable to interpret ' + adjacentSide + ' attribute: ' + target[adjacentSide]);</span>
    });
&nbsp;
    return {
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Fri Oct 09 2020 16:47:20 GMT+0300 (Moscow Standard Time)
            </div>
        </div>
